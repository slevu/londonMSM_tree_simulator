...
3. *UCSD* cluster assignement by tips    
  + With `sims.cluster.R`  
  + Cluster assignement with covariates: Merge with covariates extracted from sampleDemes
  + Add outdegrees: Skip the LSD dating of trees and source attribution already done at step 1. And combine cluster assignement with covariates and W~0~ values  
