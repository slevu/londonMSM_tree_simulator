...
#### p-values univariate
```{r, boxplot 1, warning = FALSE}
```

* neighborhood size and SA always detect difference
* uscd cluster require low threshold to start seeing the difference

#### p-values multivariate
```{r, boxplot 2, warning = FALSE}
```
